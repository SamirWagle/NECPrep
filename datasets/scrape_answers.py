"""
NEC Quiz Answer Scraper - Improved Version
...
async def submit_quiz_and_get_answers(page, url):
    ...
    # Select first option for each question and submit
    await page.evaluate("""
        () => {
    ...
    try:
        await page.evaluate("""
            () => {
                ...
                // Or try clicking submit button directly
    ...
    # The results page usually shows the correct answers highlighted in green
            ...
            for (const card of cards) {
                try {
                    ...
                    for (let i = 0; i < labels.length; i++) {
                        ...
                        // Check for green shades (correct answer indicator)
                        ...
                        if (bgColor.includes('187, 247, 208') ||
                            ...
                            bgColor.includes('21, 128, 61') ||  // green-700
                        ...
                        // Also check for red (wrong answer - means this was selected but wrong)
                        // We still want to find the green one
                    }
...
async def scrape_chapter_answers(browser, chapter_slug, chapter_info, output_dir):
    ...
    for page_num in range(1, max_pages + 1):
        ...
        try:
            ...
            # Debug: show first result's bg colors
...
async def main():
    print("="*60)
    print("NEC Quiz Answer Scraper - Improved")
